...
try:
    ...
    print("Probabilmente non hai Tkinter installato. Finche non lo farai, potrai solo usare pfactcalc in modalità testuale :(    Avvio la modalità testuale... )")
    subprocess.call('python pfactcalc-headless.py')
